  ...
  return (
    <div className="org-pane">
      ...
      <p className="org-outlook-hint">
        ...
        база <code>dc=alexol,dc=io</code>, вход — почта и пароль ящика. В книге выберите
        этот каталог (не «Другие адресные книги»). Адресная книга → Сервис → Параметры —
        отметьте его для проверки имен. Лишние папки INBOX в Outlook: правый клик → Удалить
