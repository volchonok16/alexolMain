...
export const Steps: React.FC<IProps> = ({ theme }) => {
    ...
    const logo = theme === 'dark-theme' ? '../../public/icons/logo_white.svg' : '../../public/icons/logo.svg'
    ...
    return (
        <>
            ...
            <section id="Наш путь">
                <div className="flex flex-row items-center justify-center flex-wrap gap-[40px] mt-[40px]">
                    <div className={`${bg} flex flex-col items-center justify-center lg:w-[415px] p-[7px] lg:h-[260px] gap-[6px] lg:gap-[20px] rounded-[20px] border-[1px] ${border} `}>
                        <img className="w-[20px] lg:w-[70px] h-[20px] lg:h-[70px]" src='../../public/icons/media.svg' alt="" />
                    ...
                    <div className={`${bg} flex flex-col items-center justify-center lg:w-[415px] p-[7px] lg:h-[260px] gap-[6px] lg:gap-[20px] rounded-[20px] border-[1px] ${border} `}>
                        <img className="w-[20px] lg:w-[70px] h-[20px] lg:h-[70px]" src='../../public/icons/partners.svg' alt="" />
                        <div className=" flex flex-col gap-[6px] lg:gap-[15px] items-center px-[35px] lg:px-[60px]">
                    ...
                    <div className={`${bg} flex flex-col items-center justify-center lg:w-[415px] p-[7px] lg:h-[260px] gap-[6px] lg:gap-[20px] rounded-[20px] border-[1px] ${border} `}>
                        <img className="w-[20px] lg:w-[70px] h-[20px] lg:h-[70px]" src='../../public/icons/app.svg' alt="" />
                        <div className=" flex flex-col gap-[6px] lg:gap-[15px] items-center px-[35px] lg:px-[60px]">
                    ...
                    <div className={`${bg} flex flex-col items-center justify-center lg:w-[415px] p-[7px] lg:h-[260px] gap-[6px] lg:gap-[20px] rounded-[20px] border-[1px] ${border} `}>
                        <img className="w-[20px] lg:w-[70px] h-[20px] lg:h-[70px]" src='../../public/icons/merch.svg' alt="" />
                        <div className=" flex flex-col gap-[6px] lg:gap-[15px] items-center px-[35px] lg:px-[60px]">
                    ...
                    <div className={`${bg} flex flex-col items-center justify-center lg:w-[415px] p-[7px] lg:h-[260px] gap-[6px] lg:gap-[20px] rounded-[20px] border-[1px] ${border} `}>
                        <img className="w-[20px] lg:w-[70px] h-[20px] lg:h-[70px]" src='../../public/icons/lending.svg' alt="" />
                        <div className=" flex flex-col gap-[6px] lg:gap-[15px] items-center px-[35px] lg:px-[60px]">
