    ...
    return (
        <section className="relative w-[768px] h-[500px] mx-auto text-center">
            ...
            <p className="mx-auto text-[48px] w-[520px] leading-10">
                ...
                <DividerSolid className="mx-auto mt-10" />
            </p>

            <p className="text-[20px] mt-20">
                Мы создаем будущее комфорта через инновации и технологии,
                разрабатывая решения, которые упрощают вашу жизнь и помогают
                добиваться большего. Наш подход сочетает креативность, передовые
                IT-разработки и глубокое понимание потребностей людей.
            </p>
